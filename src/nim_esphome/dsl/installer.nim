...
proc generateHtml*(installer: InstallerDefinition): string =
  ...
  html.add("            <p>On ESP32-S3 native USB boards, the serial connection drops when the chip reboots after flashing. You can connect your satellite to Wi-Fi using either method below:</p>")
  ...
  html.add("            <div>")
  html.add("              <strong>Connect Wi-Fi:</strong> The board has rebooted into your new firmware.")
  ...
  html.add("                </improv-wifi-serial-launch-button>")
  html.add("              </div>")
  html.add("              <div class=\"subtext\"><strong>Or via Wi-Fi:</strong> Connect your phone or PC to <code>Satellite Fallback Hotspot</code> and open <code>http://192.168.4.1</code>.</div>")
  html.add("            </div>")
  html.add("          </div>")
  html.add("          <div class=\"next-step-item\">")
