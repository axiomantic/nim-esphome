...
proc generateHtml*(installer: InstallerDefinition): string =
  ...
  html.add("    .action-buttons-row esp-web-install-button { flex: 2; min-width: 220px; }")
  ...
  html.add("          <span>Erase Device (Factory Reset)</span>")
  html.add("        </button>")
  html.add("      </div>")
  ...
  html.add("            <h4>Connect to Wi-Fi</h4>")
  html.add("            <p>Keep the USB cable plugged in. The installer modal will automatically prompt <strong>\"CONNECT TO WI-FI\"</strong> over WebSerial immediately after flashing finishes. Select your 2.4 GHz network and enter your password.</p>")
  html.add("            <div class=\"step-tip\"><strong>Fallback Hotspot:</strong> If the prompt is missed or USB is disconnected, connect your phone or laptop to the open Wi-Fi network <code>Satellite Fallback Hotspot</code> and navigate to <code>http://192.168.4.1</code> to enter Wi-Fi credentials.</div>")
  html.add("          </div>")
  html.add("        </div>")
  html.add("        <div class=\"guide-step\">")
  ...
  html.add("            <div>")
  html.add("              <strong>Connect Wi-Fi:</strong> The browser installer dialog will prompt <strong>\"CONNECT TO WI-FI\"</strong>. Select your 2.4 GHz network and enter your password.")
  html.add("              <div class=\"subtext\">If closed or skipped, connect your phone to <code>Satellite Fallback Hotspot</code> and navigate to <code>http://192.168.4.1</code>.</div>")
  html.add("            </div>")
  html.add("          </div>")
  html.add("          <div class=\"next-step-item\">")
